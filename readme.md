...
[@ChatGPTBot](https://twitter.com/ChatGPTBot) is a Twitter bot that you can @mention with a prompt, and it will respond with a twitter thread containing the [ChatGPT](https://github.com/khulnasoft-lab/chatgpt-api) response.

It uses the [chatgpt](https://github.com/khulnasoft-lab/chatgpt-api) Node.js package under the hood.
...
- Powered by the [Node.js ChatGPT API](https://github.com/khulnasoft-lab/chatgpt-api)
...
If you found this project interesting, please consider [sponsoring me](https://github.com/sponsors/khulnasoft-lab) or <a href="https://twitter.com/transitive_bs">following me on twitter <img src="https://storage.googleapis.com/saasify-assets/twitter-logo.svg" alt="twitter" height="24px" align="center"></a>
